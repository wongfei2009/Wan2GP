# Adapted from Tencent-Hunyuan/AuK (MIT). Weight normalization is folded into the checkpoint.

import torch
from torch import nn
from models.TTS.auk.vae.modules.commons.layers import Conv1d
...
class ResidualCouplingLayer(nn.Module):
    ...
    def __init__(self, channels, hidden_channels, kernel_size, dilation_rate, n_layers, p_dropout=0, gin_channels=0, mean_only=False, causal=True):
...
class ResidualCouplingBlock(nn.Module):
    ...
    def __init__(self, channels, hidden_channels, kernel_size, dilation_rate, n_layers, n_flows=4, gin_channels=0, causal=True):
        super().__init__()
        self.channels = channels
        self.hidden_channels = hidden_channels
        self.kernel_size = kernel_size
