...
from .attention import Attention, get_forward_context
...
class GPT2AccelAttention(nn.Module):
    ...
    def forward(
        ...
        **kwargs,
        ...
        has_kv_ctx = has_prefill_ctx or has_decode_ctx

        if not has_kv_ctx:
            # Standard causal path (no KV-cache context active).
